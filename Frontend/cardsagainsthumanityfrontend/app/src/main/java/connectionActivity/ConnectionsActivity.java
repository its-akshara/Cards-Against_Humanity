        ...
        if (requestCode == REQUEST_CODE_REQUIRED_PERMISSIONS) {
            for (int grantResult : grantResults) {
                if (grantResult == PackageManager.PERMISSION_DENIED) {
                    Toast.makeText(this,"Permission Denied! Make sure to grant this app all of the required privileges!", Toast.LENGTH_LONG).show();
                    finish();
                    return;
                }
            }
